...
export const PiSettings = makeProviderSettingsSchema(
  {
    ...
    agentDir: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        description: "Custom Pi resource and profile root (PI_CODING_AGENT_DIR).",
        providerSettingsForm: {
    ...
    launchArgs: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Launch arguments",
        description: "Additional advanced arguments passed to Pi on session start.",
...
export const PiSettingsPatch = Schema.Struct({
  enabled: Schema.optionalKey(Schema.Boolean),
  binaryPath: Schema.optionalKey(TrimmedString),
  agentDir: Schema.optionalKey(TrimmedString),
  launchArgs: Schema.optionalKey(TrimmedString),
});
export type PiSettingsPatch = typeof PiSettingsPatch.Type;
